...
SpawnChooser.Language.VersionDefault = "1.0.1" --DON'T TOUCH THIS

SpawnChooser.Language["default"] = {
	["Choose where your adventure will begin."] = "Choose where your adventure will begin.",
